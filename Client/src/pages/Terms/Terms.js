    ...
    <div className="Terms">
      <div className="Terms-all">
        ...
        <div className="Terms-body">
          <p>
            <span className="Terms-body-title">OVERVIEW</span>
          </p>
          <p>
            <span>
              This website is operated by Partake Foods. Throughout the site,
              the terms “we”, “us” and “our” refer to Partake Foods. Partake
              Foods offers this website, including all information, tools and
          ...
          <p>
            <span>SECTION 5 - PRODUCTS OR SERVICES</span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              Defective products purchased from {<NavLink to='/'>partakefoods.com</NavLink>}: To inquire
              about a refund on defective products purchased from Partake's
              website, please contact us [hyperlink to contact page]. Products
              are deemed defective at Partake's discretion. If the products are
              deemed defective, they can be refunded at partial or full refund
              to the credit card on file. If purchased with a gift card, a new
              gift card will be provided. Please note that minor damage to
              packaging is not considered defective. Defective products
              purchased from another retailer: All products thought to be
              defective purchased from a retailer must be returned to the
              retailer for replacement or refund. Partake cannot issue partial
              or full refunds for defective products not purchased through
              Partake's website. Non-defective products: There is a no refund
              policy on non-defective products.
            </span>
          </p>
          <p>
            <span>
          ...
          <p>
            <span>
              In no case shall Partake Foods, our directors, officers,
          ...
          <p>
            <span>
              You agree to indemnify, defend and hold harmless Partake Foods and
          ...
          <p>
            <span>
              ...
              accordance with the laws of 115 w 18th st, 2nd floor New York New
              York US 10011.
            </span>
          </p>
          <p>
