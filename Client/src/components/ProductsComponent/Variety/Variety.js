...
const Variety = () => {
  ...
  return (
    <div className="variety col-lg-12">
      <h2 className="title" id="variety">
        Variety Packs
      </h2>
      <div className="variety-all row">
        {variety &&
          variety.map((best) => (
            <div key={best._id} className="variety-box">
